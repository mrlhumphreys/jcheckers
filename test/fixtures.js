...
const fixtureDefinitions = {
  ...
  doubleJumpAlmostCompleteMatch: {
    klass: Match,
    args: {
      id: 1,
      current_move_from_id: 1,
      current_move_to_ids: [10],
      game_state: { 
        current_player_number: 1,
        squares: [
          { id: 1, x: 1, y: 0, piece: { id: 1, player_number: 1, king: false, selected: true }},
          ...
          { id: 9, x: 1, y: 2, piece: null },
          { id: 10, x: 3, y: 2, marked: true, piece: null },
          { id: 11, x: 5, y: 2, piece: null },
          { id: 12, x: 7, y: 2, piece: null },
  ...
  noMovesPlayerOneGameState: {
    ...
    args: {
      ...
      squares: [
        ...
        { id: 18, x: 3, y: 4, piece: null },
        { id: 19, x: 5, y: 4, piece: null },
        { id: 20, x: 7, y: 4, piece: { id: 12, player_number: 1, king: false } },
  ...
  noMovesPlayerTwoGameState: {
    ...
    args: {
      ...
      squares: [
        ...
        { id: 13, x: 0, y: 3, piece: { id: 13, player_number: 2, king: false } },
        { id: 14, x: 2, y: 3, piece: null },
        { id: 15, x: 4, y: 3, piece: null },
        { id: 16, x: 6, y: 3, piece: null },
  ...
  moveToLastRankGameState: {
    ...
    args: {
      ...
      squares: [
        ...
        { id: 25, x: 1, y: 6, piece: { id: 12, player_number: 1, king: false, selected: true } },
        { id: 26, x: 3, y: 6, piece: null },
        { id: 27, x: 5, y: 6, piece: { id: 19, player_number: 2, king: false }},
        { id: 28, x: 7, y: 6, piece: { id: 20, player_number: 2, king: false }},
  ...
  markedSquareGameState: {
    ...
    args: {
      ...
      squares: [
        ...
        { id: 14, x: 2, y: 3, piece: null },
        { id: 15, x: 4, y: 3, piece: null },
        { id: 16, x: 6, y: 3, piece: null, marked: true },
  ...
  doubleJumpAlmostCompleteGameState: {
    klass: GameState,
    args: {
      current_player_number: 1,
      squares: [
        ...
        { id: 9, x: 1, y: 2, piece: null },
        { id: 10, x: 3, y: 2, piece: null, marked: true },
        { id: 11, x: 5, y: 2, piece: null },
        { id: 12, x: 7, y: 2, piece: null},
  ...
  selectedNoJumpSquareSet: {
    ...
    args: {
      ...
      "squares": [
        ...
        {id: 14, "x":2,"y":3,"piece":null},
        {id: 15, "x":4,"y":3,"piece":null},
        {id: 16, "x":6,"y":3,"piece":{"player_number":1,"direction":1,"king":false}},

        {id: 17, "x":1,"y":4,"piece":{"player_number":2,"direction":-1,"king":false}},
        {id: 18, "x":3,"y":4,"piece":null},
        {id: 19, "x":5,"y":4,"piece":null},
        {id: 20, "x":7,"y":4,"piece":null},
  ...
  withMarkedSquareSet: {
    ...
    args: {
      "squares": [
        {"x":1,"y":1, "marked": true, "piece":{"player_number":2,"direction":-1,"king":false, "selected":false}}
      ]
    }
  },
